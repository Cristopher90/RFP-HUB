...
INSERT INTO "new_RfpQuestion" ("dependsOnHeaderField", "dependsOnQuestionId", "dependsOnValue", "id", "isPrerequisite", "locked", "options", "order", "required", "rfpId", "sourceTemplateQuestionId", "text", "type", "weight") SELECT "dependsOnHeaderField", "dependsOnQuestionId", "dependsOnValue", "id", "isPrerequisite", "locked", "options", "order", "required", "rfpId", "sourceTemplateQuestionId", "text", "type", "weight" FROM "RfpQuestion";
...
INSERT INTO "new_TemplateQuestion" ("dependsOnHeaderField", "dependsOnQuestionId", "dependsOnValue", "id", "isPrerequisite", "lockMinRole", "options", "order", "required", "templateId", "text", "type", "weight") SELECT "dependsOnHeaderField", "dependsOnQuestionId", "dependsOnValue", "id", "isPrerequisite", "lockMinRole", "options", "order", "required", "templateId", "text", "type", "weight" FROM "TemplateQuestion";
